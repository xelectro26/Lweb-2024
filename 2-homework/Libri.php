...
<!-- HEAD -->
<head>
    <!-- Impostazione del set di caratteri utilizzato (UTF-8) -->
    <meta charset="UTF-8" />
    
    <!-- Configura la pagina per essere responsive su dispositivi mobili -->
...
<body>
    ...
    <!-- Menu laterale che si apre con il pulsante sopra -->
    <div id="sideMenu" class="menu">
        <!-- Pulsante per chiudere il menu laterale -->
        <a href="javascript:void(0)" class="closebtn" onclick="closeMenu()">&times;</a>
        <!-- Link alle varie sezioni del sito -->
