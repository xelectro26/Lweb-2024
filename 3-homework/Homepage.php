...
<!-- Carousel delle immagini con frecce -->
<div class="carousel-container">
    <button class="prev" onclick="prevSlide()">&#10094;</button> <!-- Freccia sinistra -->
    
    <div class="carousel">
        <div class="galleria">
            <img src="img/cultura1.webp" alt="Affresco Romano 1">
        </div>
        <div class="galleria">
            <img src="img/affresco2.jpg" alt="Affresco Romano 2">
        </div>
        <div class="galleria">
            <img src="img/affresco3.jpg" alt="Affresco Romano 3">
        </div>
    </div>
    
    <button class="next" onclick="nextSlide()">&#10095;</button> <!-- Freccia destra -->
</div>

<p>Affreschi Romani</p>
