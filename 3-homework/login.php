...
// Debug: verifica se la sessione è attiva
if (!isset($_SESSION)) {
    die("Le sessioni non funzionano! Verifica la configurazione di PHP.");
}
?>
...
<body>
    ...
    <div class="form-container">
        <h2>Login Utente</h2>
        <form action="/Denis/3-homework/res/PHP/log-in.php" method="POST">
            <?php
